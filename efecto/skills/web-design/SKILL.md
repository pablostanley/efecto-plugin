---
name: web-design
description: Design web pages and app UIs with Efecto — create sessions, build layouts with JSX and Tailwind CSS, manage artboards, and push real-time design changes via MCP tools. Use for landing pages, dashboards, marketing sites, and responsive layouts.
---
...
**Prerequisite**: The `efecto` MCP server must be configured (`npx @efectoapp/mcp install`), or you must have access to the session REST API.
