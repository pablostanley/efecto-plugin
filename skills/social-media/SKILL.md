---
name: social-media
description: Design social media assets (Instagram, YouTube, TikTok, Twitter/X, LinkedIn, Pinterest, Facebook) with proper sizing, bold typography, and platform-specific best practices.
---

# Efecto — Social Media Design Guide

Social media assets are **posters, not web pages**. They're seen at thumbnail size in a fast-scrolling feed on a phone screen. Design accordingly: big type, few words, high contrast, bold choices.
